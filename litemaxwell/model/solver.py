...
# NOTE: the experimental rotate_rotor + backemf_sweep_moving full-remesh sliding
# band were removed — re-triangulating the whole cross-section at an arbitrary
# rotor angle C-segfaulted Triangle at some angles (uncatchable). The robust
# air-gap band layer, litemaxwell.model.band.backemf_band, replaces them: it
# meshes rotor/stator once and re-stitches only the thin gap annulus per angle.
